...
const ContactPage = () => {
    ...
    return (
        <main id='contact-page' className='mb-12 px-4 xl:container md:px-8 xl:mx-auto xl:px-0'>
            ...
            <div className='mt-8 grid grid-cols-1 gap-6 md:grid-cols-2'>
                <div>
                    ...
                    <div className='space-y-2'>
                        <p><strong>Company:</strong> BMB Construction & Services Ltd</p>
                        <p><strong>Mobile:</strong> 022 043 8005</p>
                        <p><strong>Email:</strong> johnny@bmbconstruction.co.nz</p>
                        <p><strong>Service Area:</strong> Auckland Wide</p>
                    </div>
                </div>
                <div>
            ...
            <h1 className='mt-12'>Get In Touch with Us</h1>

            <section className='mt-14 bg-secondary md:container md:mx-auto md:max-w-2xl lg:px-0'>
                <Form {...form}>
                    <form
                        onSubmit={form.handleSubmit((data) => onMyFormSubmit(data))}
                        className='bg- flex flex-col space-y-6 p-4 lg:p-10'>
                        {/* form fields */}
                                        ...
                                        <FormControl>
                                            {item.type === 'textarea' ? (
                                                ...
                                                <Input
                                                    ...
                                                    {...field}
                                                    className='placeholder:text-formText rounded-none border-b'
                                                />
                                            )}
                                        </FormControl>
                                        <FormMessage />
