...
const ServiceCard = ({ slug, title, serviceType, images }: Service) => {
    ...
    return (
        ...
        >
            ...
            <div className='relative aspect-[4/3] overflow-hidden'>
                {firstImage ? (
                    <Link href={`/services/${slug}`} className='block size-full'>
                        <Image
                            src={firstImage.url}
                            alt={firstImage.alt || 'Service Image'}
                            width={1000}
                            height={750}
                ...
                <div className='relative pl-2'>
                    ...
                    <div className='relative'>
                        ...
                        <div className='mt-2 flex items-center gap-2 opacity-0 transition-all duration-300 group-hover:opacity-100'>
                            ...
                            <span className='text-sm text-gray-200'>View Service</span>
                        </div>
                    </div>
                </div>
            </div>
