...
export default function Footer() {
    return (
        <footer className='py-8'>
            <hr></hr>
            <div className='container mt-12 px-4 md:mx-auto md:flex md:max-w-4xl md:flex-row md:justify-between md:px-8'>
                <div className='flex flex-col justify-between'>
                    ...
                    <p className='text-sm italic'>One call, one solution</p>
                    <nav className='my-6'>
